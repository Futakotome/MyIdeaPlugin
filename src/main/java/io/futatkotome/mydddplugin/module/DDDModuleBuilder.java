...
import io.futatkotome.mydddplugin.domain.service.IProjectGenerator;
import io.futatkotome.mydddplugin.domain.service.impl.ProjectGeneratorImpl;
import io.futatkotome.mydddplugin.infrastructure.DataSetting;
import io.futatkotome.mydddplugin.infrastructure.ICONS;
import io.futatkotome.mydddplugin.infrastructure.MsgBundle;
...
public class DDDModuleBuilder extends ModuleBuilder {
    ...
    @Override
    public @Nullable
    ModuleWizardStep modifySettingsStep(@NotNull SettingsStep settingsStep) {
